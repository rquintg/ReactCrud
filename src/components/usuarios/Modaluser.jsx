...
export default function Modaluser({estado, loading, hidden, error, add, closeModal, changeEstado}) {
    return (
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">{estado._id ? 'Editar usuario' : 'Ingrese nuevo usuario'}</h5>
                        &nbsp;&nbsp;
                        {
                            (loading &&
